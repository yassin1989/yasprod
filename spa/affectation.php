                    ...
                    <div class="white-box">
                        ...
                        <h3 class="box-title m-b-0">Affectation de planning Journaliere Cabine To Therapeute </h3>
                            ...
                            <div class="sttabs tabs-style-bar">
                                <nav>
                                    <ul>
                                        <li><a href="#" class="sticon ti-user"><span>Affectation</span></a></li>
                            ...
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								Probléme d'affectation, Choisir une date differente,Merci! 
								</div>      
										<?php } ?>
                                        <br>          
...
?>
                            <option value="<?php echo $idc ?>"><?php echo ucfirst($nom).'--> '.($type) ;?></option>
                          <?php    				
						 } 
...
?>	
   ...
   <input type="text" name="date" class="form-control" id="datepicker-autoclose" value="<?php echo date('Y-m-d',strtotime($date)) ?>" placeholder="<?php echo date('Y-m-d',strtotime($date)) ?>">
               ...
               <input type="text" class="form-control" id="start" name="start" value="<?php echo date("H:i") ?>" required > 
     ...
     <div class="input-group clockpicker " data-placement="bottom" data-align="top" data-autoclose="true">
                                        <input type="text" class="form-control" id="end" name="end" value="<?php echo date("H:i") ?>" required > 
										    <span class="input-group-addon"> 
											   <span class="glyphicon glyphicon-time"></span> 
										    </span>
