        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Therapeute History</h4> </div>
                    ...
                    <div class="white-box">
                        <!-- Tabstyle start -->
                            <div class="sttabs tabs-style-bar">
                                <nav>
                                    <ul>
										<li><a href="#" class="sticon ti-id-badge"><span>Therapeute History</span></a></li>                                       
                                      </ul>
                                </nav>
                                <div class="content-wrap">
									<div class="panel-body"><br>
								<form name="f2" method="get" action="agent_history.php" >
								<div class="row">
								<div class="col-md-3">                        
                               <div class="example">
                                 <label class="control-label">Choose therapeute</label>
                                 <div class="input-group">
                         <select class="form-control" name="agent" id="guest">
                                <?php
...
?>
                             <option value="<?php echo $id ;?>"><?php echo ucfirst($name) ;?>							
						  </option>
                          <?php    				
						 } 
                           ...
                           <input type="text" class="form-control" name="start" value="<?php echo $st  ?>" /> 
                            ...
                            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
								...
								if(!isset ($_GET['agent']))
									   ...
									   <?php
								// $idc=$_GET['guest']; 
		$sql = "SELECT *  FROM reservation where id_agent='$idc' and date >='$st' and date <= '$ed'  ";
 			 		$req= mysql_query ($sql) ;
						$number=mysql_num_rows($req);
						 while($data= mysql_fetch_array($req)) 
 								 {		
