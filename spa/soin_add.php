        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Add Soin</h4> </div>
                    ...
                    <div class="white-box">
                        ...
                        <h3 class="box-title m-b-0">Soins Informations </h3>
                            ...
                            <div class="panel-body">
                                 <form method="post" name="f1" action="insert_soin.php">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="Name" class="form-control" placeholder="Name" required> <span class="help-block"> Add New Product </span> </div>
                                            </div>
											<div class="col-md-4">
                                             <div class="form-group">
...
?>
                            <option value="<?php echo $id ;?>"><?php echo ucfirst($nom.'--'.$type) ;?></option>
                          <?php    				
						 } 
...
?>	
											    ...
											    <div class="col-md-3">                                                  
                                                   ...
                                                   <textarea class="form-control form-control-line" rows="5" name="descri"></textarea>
													<span class="help-block"> Add Discreption Of products </span> 
												</div>
                                             </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="prix" name="prix" class="form-control" placeholder="">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="control-label">Durée</label>
                                                        ...
                                                        <option value="14">15 min</option>
                                                        <option value="19">20 min</option>
                                                        <option value="24">25 min</option>
                                                        <option value="29">30 min</option>
                                                        <option value="34">35 min</option>
                                                        <option value="39">40 min</option>
                                                        <option value="44">45 min</option>
                                                        <option value="49">50 min</option>
                                                        <option value="54">55 min</option>
                                                        <option value="64">65 min</option>
                                                        <option value="69">70 min</option>
                                                        <option value="84">85 min</option>
														<option value="89">90 min</option>
                                                        <option value="94">95 min</option>
														<option value="99">100 min</option>
                                                        <option value="119">120 min</option>
														<option value="149">150 min</option>	 
													    <option value="179">180 min</option>                                             
                                                        <option value="840">840 min(DayOff)</option>                                                    
                                                    </select>
