                    ...
                    <div class="white-box">
                        <!-- Tabstyle start -->
                            <div class="sttabs tabs-style-bar">
                                <nav>
                                    <ul>
										<li><a href="#" class="sticon ti-id-badge"><span>Statistic Agent</span></a></li>                                        
                                      </ul>
                                </nav>
                                <div class="content-wrap">
									<div class="panel-body"><br>
								<form name="f2" method="get" action="agent_rapport.php" >
								<div class="row">
											<?php
...
?>
		...
		$sql = "SELECT *  FROM reservation where id_agent='$idagent' and paye='payer' and status='confirmer' and date >='$st' and date <= '$ed'  ";
 			 		$req= mysql_query ($sql) ;
...
$sql6 = "SELECT * FROM soins s,reservation r where  r.id_soin=s.id_soin and r.paye='payer' and status='confirmer' and  date >='$st' and date <= '$ed'   "; 						
	...
	$sql7 = "SELECT * FROM soins s,reservation r where r.id_agent='$idagent' and r.id_soin=s.id_soin and r.paye='payer' and status='confirmer' and date >='$st' and date <= '$ed'   "; 						
