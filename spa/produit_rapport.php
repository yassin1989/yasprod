...
<?php
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Produit History</h4> </div>
                    ...
                    <div class="white-box">
                        <!-- Tabstyle start -->
                            <div class="sttabs tabs-style-bar">
                                <nav>
                                    <ul>
										<li><a href="#" class="sticon ti-id-badge"><span>Statistic produit SPA </span></a></li>                                        
                                      </ul>
                                </nav>
                                <div class="content-wrap">
									<div class="panel-body"><br>
								<form name="f2" method="get" action="produit_rapport.php" >
								<div class="row">
											<?php
		...
		$sql = "SELECT id_soin, COUNT(id_soin) as nbre FROM reservation where  paye='payer' and status='confirmer' and date >='$st' and date <= '$ed'
		 GROUP BY id_soin
          ORDER BY nbre DESC
		";
 			 		$req= mysql_query ($sql) ;
						$number=mysql_num_rows($req);
						 while($data= mysql_fetch_array($req)) 
 								 {		
									    ...
									    <td align="left"><?php echo $ids ;?></td>									   
									    <td align="left">
											<?php 
											                            
		$sql1 = "SELECT s.id_soin,s.nom,s.prix ,r.id_soin FROM soins s,reservation r where r.id_soin=s.id_soin and r.id_soin=$ids  "; 							
 								     ...
 								     {		
									    ...
									    <td align="left"><?php echo $nbre ;?></td>								   
									    <td align="left"><?php  $total = $prix*$nbre ; 
