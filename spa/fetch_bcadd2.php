...
$stid = oci_parse($c,'select GUEST_NAME_ID,ROOM,SFIRST_GUEST_NAME,SGUEST_NAME,ARRIVAL,DEPARTURE,ADULTS,COMMENTS from OPERA.REP_RESERVATION_FIN_ALL where RESV_STATUS = :dd  AND 
ROOM<2000   
...
<div class="row">
 <div class="col-md-12">      
       <label class="control-label"> Coms </label>
            <input type="text" name="coms0" id="coms0" class="form-control"   value="<?php echo $coms ; 	 ?>" disabled> 
	 <input type="hidden" name="coms" id="coms" class="form-control"  value="<?php echo $coms ;	 ?>"> 
					  <span class="help-block"> </span> 				
