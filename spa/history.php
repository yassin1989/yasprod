                    ...
                    <div class="white-box">
                        ...
                        <h3 class="box-title m-b-0">Affichage des Reservations  </h3>
                            ...
                            <div class="sttabs tabs-style-bar">
								...
								<form name="f2" method="get" action="history.php" >
								<div class="row">
								<div class="col-md-3">                        
                               <div class="example">
						...
						$number=mysql_num_rows($req);
						 while($data= mysql_fetch_array($req)) 
 								 {		
							            ...
							            $date_sup = $data['date_supp'];
							         							            							         
?>
										<td><?php echo $id ;?></td>
										<td><?php                             
						$sql0 = "SELECT c.id_client,c.name,c.room ,c.last ,r.id_client FROM client c,history r where r.id_client=c.id_client and r.id_client=$client  ";
 								     ...
 								     {		
									   ...
									   <td><?php echo ucfirst($type) ;?></td>
										<td>  
										 <?php                             
							 	$sql1 = "SELECT s.id_soin,s.nom ,r.id_soin FROM soins s,history r where r.id_soin=s.id_soin and r.id_soin=$soin  "; 							
 								     ...
 								     {		
										...
										<td><?php                             
						$sql2 = "SELECT a.id_agent,a.nom ,r.id_agent FROM agent a,history r where r.id_agent=a.id_agent and r.id_agent=$agent  ";
 								     ...
 								     {		
										...
										<td>
									   <?php                             
				$sql3 = "SELECT c.id_cabine,c.name ,r.id_cabine FROM cabine c,history r where r.id_cabine=c.id_cabine and r.id_cabine=$cabine  ";
						...
						<?php echo ucfirst($paye);?>
					
						</td>  
							 </td>		                                         
									
								<td> 							
								<?php echo $date_ajout ;?> </td>
									<td> 											
								<?php echo $date_sup ;?>	
								   </td>
