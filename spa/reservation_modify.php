											...
											<div class="col-md-2">
                                                <div class="form-group">
													...
													<select class="form-control" name="types">
														 <option value="<?php echo $types ?>" selected><?php echo $types ?></option>  
                                                        <option value="Soin à la carte">Soin à la carte</option>             
...
?>	
                                ...
                                <?php
		$sql = "SELECT * FROM agent a , affectation f where a.id_agent=f.id_agent and  f.date='$date'  ";
 			 			$req= mysql_query ($sql) ;
						$number=mysql_num_rows($req);
						 while($data= mysql_fetch_array($req)) 
 								 {		
                                                ...
                                                <div class="form-group">
                                                  <label class="control-label">Payement</label>
                                                    <select class="form-control" name="paye">													
														<option value="<?php echo $paye  ?>" selected><?php echo $paye  ?></option>
														<option value="non-payer">Non Payer</option> 
                                                        <option value="payer">Payé</option>
                                                        <option value="offet">Offet</option>                                                       
                                                     </select> 
										 </div>
                                          </div>
												   <div class="col-md-2">
