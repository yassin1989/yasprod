...
<head>
  ...
  var element = document.getElementById('dof2');
        ...
        xmlhttp.open("GET","fetch_date.php?d="+x,true);        
                        ...
                        <h3 class="box-title m-b-0">Reservation clients  </h3>
                            ...
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								Therapeute et/ou cabine indisponible dans cette date ! 
										...
										<?php } ?>
                                <form method="post" name="f1" action="insert_resv.php">
                                    <div class="form-body">
										<div class="row">
								 ...
								 <div class="col-md-3">											   
                                  <div class="form-group">
                                   ...
                                   <div class="input-group clockpicker " data-placement="bottom" data-align="top" data-autoclose="true">
                                        <input type="text" class="form-control" id="time" name="time" value="<?php echo date("H:i") ?>"> 
