                                    ...
                                    <div class="col-in row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right m-t-15 text-danger"><?php
												$now=date("Y-m-d");
						$sql="select * from reservation where date='$now' and id_client != 47 and status not like 'Annuler' ";
												$req= mysql_query ($sql) ;
...
$count5=mysql_num_rows($req5);	
		echo $count5;
						...
						<?php 
			$np="non-payer"	;			 
$sql6 ="select * from reservation WHERE paye='$np' and id_client!= 47 ";
		   ...
		   <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="row row-in">
                            	<div class="col-md-8">                        
                               	 <label class="control-label">Choisir une Date </label>
                                   <div class="input-group">
                    <input type="text"  size="20" name="date" class="form-control" id="datepicker-autoclose" value="<?php echo date("Y-m-d") ?>">								     
									   &nbsp;
                   <button type="submit" class="btn btn-success" ><i class="fa fa-search"></i>Go Find</button>
				   				   &nbsp;&nbsp;		   				  
							    <button class="btn btn-warning" onclick=" window.open('reservation.php')"> Reservation</button>	 &nbsp;&nbsp;		   				  
							    <button class="btn btn-dark" onclick=" window.open('client_add.php')"> Gestion Client</button> &nbsp;&nbsp;		   				  									
							    <button class="btn btn-danger" onclick=" window.open('affectation.php')"> Affectation</button>	&nbsp;&nbsp;							
							    <button class="btn btn-warning" onclick=" window.open(reservation_all.php')">All Reservation</button>								
								</div>
								</div>
                            </div>
                        </div>
