                    ...
                    <div class="white-box">
                        <!-- Tabstyle start -->
                            <div class="sttabs tabs-style-bar">
								...
								<form name="f2" method="get" action="agent_caf.php" >
								<div class="row">
								<div class="col-md-3">                        
                               <div class="example">
...
?>
                             <option value="<?php echo $ida ;?>"><?php echo ucfirst($name) ;?>							
						  </option>
                          <?php    				
						 } 
...
$sql6 = "SELECT * FROM soins s,reservation r where  r.id_soin=s.id_soin and r.paye='payer' and status='confirmer' and  date >='$st' and date <= '$ed'   "; 						
	...
	$sql7 = "SELECT * FROM soins s,reservation r where r.id_agent='$idc' and r.id_soin=s.id_soin and r.paye='payer' and status='confirmer' and date >='$st' and date <= '$ed'   "; 						
		...
		$sql = "SELECT *  FROM reservation where id_agent='$idc' and paye='payer' and status='confirmer' and date >='$st' and date <= '$ed'  ";
 			 		$req= mysql_query ($sql) ;
						$number=mysql_num_rows($req);
