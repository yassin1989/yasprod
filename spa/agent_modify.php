...
$id_agent=$_GET['id']; //echo $id_agent.'<br>' ;
//$ids=$_GET['ids']; //echo $id_soin.'<br>' ;
?>
                    ...
                    <div class="white-box">
                        ...
                        <h3 class="box-title m-b-0">Add Therapeute Informations </h3>                                     
                            <div class="sttabs tabs-style-bar">
                                <nav>
                                    <ul>
                                        <li><a href="agent_add.php" class="sticon ti-user"><span>Add Therapeute</span></a></li>
                            ...
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								Modification est faite avec succes !
								</div>      
										<?php } ?>
                                <form method="post" name="f1" action="agent_update.php">                                  
...
?>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="Name" value="<?php echo ucfirst($nom) ;?>" class="form-control" placeholder="Name" required> <span class="help-block"> Therapeute Name </span> 
												</div>
                                            </div>
                                            <!--/span-->
                ...
                <div class="col-md-6">
                  ...
                  <select multiple="multiple" class="select2 m-b-10 select2-multiple" multiple data-style="form-control" name="speciality[]">
                      ...
                      $sql2 = "SELECT * FROM aff_agent where id_agent=$id_agent and id_soin='$id'   ";
...
?>
          <option value="<?php echo $id ?>" <?php if($number >0){?> selected <?php } ?>><?php echo $name?> <?php if($number >0){   } ?></option>
                                  ...
                                  <option value="dimanche">Dimanche</option>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="Phone" value="<?php echo ucfirst($phone) ;?>" name="phone"class="form-control" placeholder=""> <span class="help-block"> Phone Number</span>
												</div>
                                            </div>
                                            <!--/span-->
											 <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="score" value="<?php echo ucfirst($score) ;?>" class="form-control" name="score" placeholder=""> <span class="help-block"> Score </span> </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success" name="submit"> <i class="fa fa-check"></i>Save Update</button>
