                    ...
                    <div class="white-box">
                        ...
                        <h3 class="box-title m-b-0">Add Client Informations </h3>
                            ...
                            <form method="post" name="                  
                                <form method="post" name="f1" action="insert_client.php">
                                    <div class="form-body">
                                        <div class="row">
											  <div class="col-md-2">
											...
											<div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="email" name="email" class="form-control" placeholder=""> <span class="help-block">email </span> </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        <!--/row-->
                                            ...
                                            <div class="col-md-3">
											  ...
											  <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="room"  name="room"class="form-control" placeholder=""> <span class="help-block"> Room</span> </div>
                                            </div>
											<div class="col-md-2">
                                              <div class="form-group">
                                              <label class="control-label">Birth Date</label>
                                              <input type="date" id="date"  name="date" class="form-control" <?php echo date('Y-mm-dd'); ?>placeholder=""> <span class="help-block">Birth Date</span> </div>
                                            </div>
                                            <!--/span--
                                            <!--/span-->											
											   <div class="col-md-3">
