...
$sql5 ="select * from reservation WHERE ((start_time between '$commence' and '$fini') or (endtime between '$commence' and '$fini')) and (id_agent ='$agent' or  id_cabine='$cabine') and id_res != $idres ";
...
//ajout reservation
$sql=mysql_query("UPDATE reservation SET date='$date_res',start_time='$commence',endtime='$fini',status='$status',note='$note',paye='$paye',id_cabine='$cabine',type_soin='$type_soin',id_soin='$soin',id_agent='$agent',date_modif='$datenow',auteur='$moi' where id_res =$idres ");
