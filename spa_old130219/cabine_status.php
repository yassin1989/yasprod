        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <!-- Tabstyle start -->
                        <h3 class="box-title m-b-0"> Cabine Informations </h3>
                                          <section>
                            <div class="sttabs tabs-style-bar">
                                <nav>
                                    <ul>
                                        <li><a href="cabine_add.php" class="sticon ti-home"><span>Add Cabine</span></a></li>
                                        <li><a href="#" class="sticon ti-notepad"><span>Affichage Status</span></a></li>
                            ...
                            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Name</th>
                                        <th class="center">Type de Cabine</th>
                                        <th >Status</th>
                                        <th>Special Pour</th>
                                        <th>Action</th>                                                                                                                       
                                    </tr>
